                        ...
                        next () {
                            ...
                            if (iterationIndex < 0) {
                                ...
                                return {
                                    ...
                                    value: self.array[iterationIndex--]
                                }
                            }
                        }
                    }
...
describe('A Coffeehouse: Symbols', function () {
    ...
    it('Create private with Symbol', function () {
        const array = Symbol(),
            head  = Symbol(),
            tail  = Symbol();
        ...
        q.pullHead().should.equals("hello");
...
describe('Life on the Plantation: Metaobjects', function () {
    ...
    it('This function forwards methods to another object', function () {
        ...
        investor.netWorth().should.equal(3000000);
